    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visitors_number', models.IntegerField(validators=[django.core.validators.MaxValueValidator(100),
                                                                    django.core.validators.MinValueValidator(1)])),
                ('exhibitors_number', models.IntegerField(validators=[django.core.validators.MaxValueValidator(100),
                                                                      django.core.validators.MinValueValidator(1)])),
                ...
                ('status', models.CharField(blank=True, choices=[('Complete', 'Complete'), ('InProgress', 'InProgress'),
                                                                 ('Error', 'Error')], max_length=12, null=True)),
            ],
        ),
    ]
